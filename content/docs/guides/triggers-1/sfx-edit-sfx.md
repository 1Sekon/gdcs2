...
{{< img src="https://lh3.googleusercontent.com/d/1NuHdJN5htewog6oaTLTLXvpaSzweX6JL" >}}

You can select the sound effect you want by clicking on the tablelist button in the top right corner of the UI.

{{< img src="https://lh3.googleusercontent.com/d/1CyDDv-Q4V7xVll8hFkHEAQujvx4nBjvJ" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1Ska9vbP79cL3FJP8rh72HmYqcvj0s-6b" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1eULzqlJC8kt0AudTUc8oePPYvwpuKYDr" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1kwssgJ6xOwcjxfGGMoTsf_vbAVYYIbSg" >}}

Speaking of which, let's talk about the SFX options on the first page:

- As mentioned in the [Song Trigger](/docs/guides/triggers-1/song-edit-song/), the **Speed slider** __changes the velocity of the song__ that is played in the channel.
...
{{< img src="https://lh3.googleusercontent.com/d/1HTo4Tp6QfbySbXbYOFBVOdbqfj-dED8p" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1twXUNTqqiGxaYFwrQfjJmqiv3_qRNAGZ" >}}
- and this is a sine wave played at C3.

{{< img src="https://lh3.googleusercontent.com/d/1DIqIZqLkc97H_Geg-vT0ezal6lILPwiK" >}}
...
- **Reverb**: __Causes the sound to be repeated and bounced around numerous times in an echo__. These could be used to insinuate a sense of space in an enclosed area in real life through sound. Tighter reverb details a small room (like a bathroom), while a big, open reverb details a big room (like a church).
- Clicking on the + Button on reverb presents you with a bunch of presets made for reverberation.

{{< img src="https://lh3.googleusercontent.com/d/1MPS3UqPMbbw3Z_LYPw_JkDvLD-OsSRyj" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1--6u2BjlIaqpEICez-Ku9Wuj-w3_lzNs" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/106oF2E9m3glzOCXknZs6W-INMWgnutkO" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1zu86A0mLdEAoZzytx-_mg-8VDphBZb7z" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1SGixR4zb5imNAPsLPTlSBLLeyTBcsS9I" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/15w45AlrWBbbVaE7G8YNaCOsj_QAxpH6k" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1dl3sAZ_hRVImgnHx6qJYe57ch4qeSjlI" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1VJXZOwq21g9SEtatvtJYQmDv7MNmqqcp" >}}

# 2: Edit SFX Trigger

Place down the Edit SFX Trigger. It is shown below.

{{< img src="https://lh3.googleusercontent.com/d/1IcipJhlyHR33sO-H7OecFHT_upEtpkzO" >}}

When selected, click on the {{< img src="images/GDEmotes/Buttons/EditObject.png" class="emote">}} Edit Object button. Below is the first page of the Edit SFX trigger.

{{< img src="https://lh3.googleusercontent.com/d/10nOjkprPboqYbDX4w9NCumLdKryyY7UJ" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1oVHsJelojsBMmwbngm4VqvOzBL_vGF8S" >}}
...
{{< img src="https://lh3.googleusercontent.com/d/1eSRwQx_g7RcAc7pWslA6CTrXItu3T7-N" >}}

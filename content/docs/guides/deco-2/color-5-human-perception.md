...
**Stygian colors** are types of color that are **both impossibly dark and saturated**.
...
**Hyperbolic colors** are those that are **more saturated than the purest of those colors.**

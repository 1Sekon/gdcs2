...
As the name suggests, **Follow Through** outlines how **even when an object stops moving, some of its parts continue moving before gradually coming to a stop.** This principle best resembles Newton’s first law of motion: an object remains moving until an external force acts on it. Let’s visualize this by comparing two examples:
...
{{< gif src="https://lh3.googleusercontent.com/d/1V62AUXqcR0AUmkc9GdGPslJfDa9MXH6R" >}}
...
{{< gif src="https://lh3.googleusercontent.com/d/1okIAEaJzhw-FdQ41tpoFASPC77VfTLZU" >}}
...
A great example is found in the dragon’s movements in Against the by 1374.

{{< youtube id="naX3GvvumWA" start="174" >}}

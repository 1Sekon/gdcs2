...
<span style="color: gray; font-size: 13px">*Small differences can lead to different results, even though the player did almost all of the inputs correctly. This is an example of a small part from Zip Lash by GD Colon*</span>
...
<span style="color: gray; font-size: 13px">*The movement feels much more substantial and satisfying after the visuals and sound effects.*</span>

...
- Cucumber
- Click to place objects. Geometry Dash!
...
Bread is an essential part of making a ~~burger~~. Wait, weren’t we just talking about sandwiches? Well actually a burger is a sandwich, so you’re wrong.

Anyways, bread does not exist. Instead, we need to make our own bread. First, get some wheat and put 3 bundles in a straight line. Boom, bread. Now that you have made some bread, you have a couple options.

Option one is to make Toast, which we’ll cover in next year's guide (probably idk maybe not). Option two is to make a sandwich, which you can make. You can read about how to make a sandwich in \[this guide](docs/guides/deco-3/making-a-sandwich/)
...
@Mythoclastin go build rare animal
...
You’re ████ and I condemn you all to the ████████ where we keep the ███████ of █████ for the sole purpose of “Guide Writing”.

> Should we just leave our conversations here for the funnies hurray
>
> Yeah
>
> A hot dog is not a taco
>
> Can someone add another header section of “3. Add some Bleach” I wanna write something
>
> , just a duplicate of it lol
>
> I’m gonna delete this entire section
>
> DO NOT include in release version. Or else you ALL are getting demoted
>
> No include it for the shits it’ll be funny to have them know our presence in the third person. World building yknow?
>
> No
>
> Ur so lame for that ;(
...
To add bleach to a sandwich of your choice, we must first acknowledge that the peanut Butter sandwich is a marvel of engineering. Why? Well, to start, the peanut Butter sandwich by itself is made to hold itself together by the cosmic forces above. And also friction from the peanut butter, but who cares. You can also add jelly, but I prefer no jelly because I love the taste of peanut Butter. Also, it always falls peanut Butter side down. Clearly this means the ones above are pulling the strings so 10th dimensional energy leaks and makes the sandwich fall butter side down.

If you have a peanut allergy you can substitute peanut Butter for the teleport trigger, works just as well IMO. Just make sure to set the Group ID to the first bread piece. 

Coming back to the bleach section, you must first have the prerequisite of having the sandwich *open faced*, not closed. If it is closed this step will not work. Unscrew the bleach container, and pour onto either slice of bread. ᗪỖ 𝐍σＴ ℙ𝐎ǗＲ Ỗภ Ⓑ𝐎тᕼ ιή т𝔥𝔢 мเＤᗪl𝓔, 𝐓ђ𝔼 ς𝔬ᶰร𝐓ℝυ¢𝕥 Ｏᶠ 𝐫ⓔÃˡⒾt𝓨 ａร 山𝔼 кᶰØω ᶤｔ 𝐖𝓲ˡĻ ¢ⓄĹ𝕝𝕒ρ𝓢є αℕ๔ 𝓌ᵉ ＷιｌＬ αᒪ𝐥 𝐟𝒶Ⓛℓ 𝐈Ⓝⓣ𝐎 ᗩη Ｅт𝓔ᖇⓝ𝔞Ｌ cⓨ𝕔ℓ𝔢 𝓞Ŧ sＵ𝕗ⓕⒺ尺ι𝔫𝕘. After applying bleach, you can then close the sandwich once more. Be careful not to touch the bleach, it will saponify the oils in your skin and may cause chemical burns if not rinsed off properly. 

If you need extra help with these steps, please refer to Section 6.
...
If you are having trouble with these formulas, you can use [this visualizer](https://www.desmos.com/calculator/vve2qlpwtp) made by [Intercomprehensible](https://www.youtube.com/@hhsyiahrudt) if you want a more visual explanation of the formulas.

After seeing all these complicated formulas, you might be thinking “Kyaa\~! M-Math?? In a s-sandwich guide?? >///< I- I can’t do this its s- so scawwy\~!!!” Well, I ain’t reading allat.

Anyways, back to sandwiches. Wait, sorry I forgot what this guide was about. Let’s explain eigendecomposition. To explain eigendecomposition, first we have to think about Linear Algebra, but you see, Linear Algebra has a bit of calculus and also everything before precalculus as a requisite, so first learn precalculus and whatever then come back. If you don’t come back, just remember I know where you live.
...
# 9: My sword sword sword my diamond sword sword sword my diamond sword sword the one you cant afford ford ford ford.

# 10: Oh no 7 why did you eat 9
...
>
> What: Yeah, Not doesn’t know me.
>
> Yeah: Why are you talking to me?
>
> Why: No, I’m not talking to you.
>
...
# **🔔🔔🔔🔔IT WAS ALL EGOCENTRISM. PRAISE BE DEFIANT GOUGE**

As you can see from ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎

The caption, we are observing ImaginaryIQ having a stroke and thinking that Egocentrism is the best item in Risk of Rain 2. It probably converted all of his braincells into more stacks of Egocentrism. To understand this epic horrible inside joke to its fullest capacity and ultimately lose 15 braincells per second you must first understand what Risk of Rain 2 is.
...
1. **Color:** The hue and saturation of your sandwich. Usually brown, occasionally neon green when exposed to high concentrations of radiation (not recommended, makes the bleach taste bad).
2. **Value:** The brightness/darkness the sandwich has. While this is technically part of color, human eyes are especially sensitive to value. This makes mastering value a crucial part of sandwich making.
3. **Line:** Generally, a line connection between two points in space. Lines can have varying thickness and be implied (for instance, ellipses like these make a line ………). Lines can be straight or curved, and are usually distinguished by using color and/or value. More specifically, these will usually be the *edges* of your sandwich.
4. **Shape:** The 2-dimensional area a topping has. Shapes are usually distinguished with one of the three elements above (color, value, or lines). There are many types of shapes, and alongside color they’re one of the main ways to distinguish the toppings in your sandwich from one another.
5. **Form:** The 3-dimensional area your sandwich has. Since we live in 2D, this is usually an illusion of depth. You can make sandwiches appear to be 3D using perspective, overlapping objects, and color tricks.
6. **Space:** The area between and inside shapes. This can be positive space, such as the space taken up by toppings, or negative space which is the area between them. Both types of space are important to consider, especially for visual effects and transitions.
7. **Texture:** The material a sandwich has. Almost always it is bleach-soaked bread. Occasionally, it can be peanut butter mixed with jelly, or me. Speaking of me, I’m gay btw. I know I mentioned it earlier, but it’s just in case you forgot.

# 13: Some Exercises

Here are some simple exercises you can do to master your sandwich making skills:

1. ~~Create a **trigger function** that solves the equation of  ✈ + (t - 2) = 52% / 5. This exercise is completely unrelated to making sandwiches but you can do it as a warmup and because the trigger gods told me to include it. (Please save me, I’m a deco creator being held at gunpoint)~~

## This message has been removed by the overseers. Please continue on with the guide.

# 13: For Real This Time

1. Now that the warmup is all said and done we can move up to the real deal. **Gather some random objects** (3-5 is optimal) around your house and (without contemplating your life choices) determine if they are suitable for making a sandwich in real life (irl) or in the GD editor. Take a **picture of each of the objects**, along with a **100 word essay on each individual one about why they would/wouldn’t fit** and send a message in #exercises. Title your post “Gullible”. ‼️IMPORTANT‼️: One of your items MUST be bleach (it’s suitable btw).
2. Now that we’ve determined which objects can be used to make a sandwich, you will be tasked to make one yourself. Install the **Image2GD mod** and recode it in a way to **reverse the process**. You should now be able to place objects from the GD editor in real life. Actually… screw making a sandwich. Now you can literally become Geometry Dash in real life. Use this to your advantage when needed.
3. *Unfortunately, the person responsible for writing this exercise has gotten sidetracked and is now placing spikes in public places*. Go to the nearest police station and **report this behavior** to the authorities (if you don’t like fun that is…). Upon successfully completing this exercise you will be awarded **moderator status** in the GDCS server.
4. Please, build a machine that allows people to turn into cubes, I would be really thankful and could die peacefully. 

After completing all of these really easy exercises, you can consider yourself a sandwich. That’s right: You become part of this guide and everything it stands for and will be trapped inside of here forever.


# 14: Sandwich Placement

To understand the placement of a Sandwich, you need a few things. This step is entirely **optional**, and can choose to be done if you want a higher quality presentation for your sandwich.

To start, you’d need a plate of sorts. Ceramic works, but then you have to do nasty stinky dishes. Ew. I prefer paper because I can just throw away the mess and then use the paper plate as a thingy to clean the table. Creativity !!!

You must use your phalange(s) to pick up the construct known as the “Sandwich,” whatever is even defined by a sandwich. The definition of a sandwich is a complex topic and should be tackled some other day. Once the sandwich is firmly within grasp, make sure to be delicate. This sounds like a paradox, but making sure you won’t drop the sandwich when picking it up while also making sure not to demolish the sandwich with your Cheeto covered fingers, because ~~you’re a fat chud and I hate you~~. Place the sandwich on the plate 🍽️ 

Om nom nom nom 😋 

Sorry I ate the sandwich. Make me another one or you’re gonna sleep in the basement again

# 15: did you make the sandwich yet

I’m hungry

# 16: I ran out of ideas to write

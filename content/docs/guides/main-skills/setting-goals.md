...
* Achievable: Ensure your goal is realistic and within your skill level. Setting an achievable goal prevents frustration and burnout.
...
# 4: Important Warnings for Setting Goals
...
1. Extend the time frame of the goal you want to achieve.
2. Break it into even smaller goals you'd be able to achieve and with ease.

Doing this can give you significantly more time to work on big goals. Alternatively, having small short term goals can help you take the little steps you need to (slowly, but surely) make progress towards bigger goals.
